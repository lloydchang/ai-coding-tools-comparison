...
**A skill is knowing which tool fits the shape of work at hand, when, where, why, how, for what, and for whom.**
...
**Architectural patterns in this document describe differences, not a ranking.** What fits depends entirely on everything above.
...
| Windsurf Cascade / Devin      | Supervisor of autonomous AI teammate |
...
> **Plausible Cognition position:** Cognition spans two categories - Deep collaborator inside IDE and Supervisor of autonomous AI teammate.

> **Plausible Google position:** Google spans two categories - Jules in the Cloud Agent model and Antigravity in the Hybrid Autonomous IDE model. Combined with their underlying model and infrastructure layer, they have a credible play across the full autonomous end of the spectrum.
