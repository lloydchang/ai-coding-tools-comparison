...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Event Listeners
    document.getElementById('compare-results-button').addEventListener('click', openModal);
    document.getElementById('llm-header').addEventListener('click', () => sortTable('llm'));
    document.getElementById('name-header').addEventListener('click', () => sortTable('name'));
    document.getElementById('ai-independence-header').addEventListener('click', () => sortTable('aiIndependenceLevels'));
    document.getElementById('persona-header').addEventListener('click', () => sortTable('persona'));
    document.getElementById('workflow-header').addEventListener('click', () => sortTable('workflow'));
    document.getElementById('pricing-header').addEventListener('click', () => sortTable('pricing'));
    document.getElementById('indemnity-header').addEventListener('click', () => sortTable('indemnity'));
    document.getElementById('notes-header').addEventListener('click', () => sortTable('notes'));

    document.getElementById('llm-header').addEventListener('keydown', (event) => handleKeySort(event, 'llm'));
    document.getElementById('name-header').addEventListener('keydown', (event) => handleKeySort(event, 'name'));
    document.getElementById('ai-independence-header').addEventListener('keydown', (event) => handleKeySort(event, 'aiIndependenceLevels'));
    document.getElementById('persona-header').addEventListener('keydown', (event) => handleKeySort(event, 'persona'));
    document.getElementById('workflow-header').addEventListener('keydown', (event) => handleKeySort(event, 'workflow'));
    document.getElementById('pricing-header').addEventListener('keydown', (event) => handleKeySort(event, 'pricing'));
    document.getElementById('indemnity-header').addEventListener('keydown', (event) => handleKeySort(event, 'indemnity'));
    document.getElementById('notes-header').addEventListener('keydown', (event) => handleKeySort(event, 'notes'));
});
