...
// LOGIC
// ==========================================
function handleKeySort(event, col) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('llm').addEventListener('click', () => sortTable('llm'));
    document.getElementById('llm').addEventListener('keydown', (e) => handleKeySort(e, 'llm'));
    document.getElementById('name').addEventListener('click', () => sortTable('name'));
    document.getElementById('name').addEventListener('keydown', (e) => handleKeySort(e, 'name'));
    document.getElementById('aiIndependenceLevels').addEventListener('click', () => sortTable('aiIndependenceLevels'));
    document.getElementById('aiIndependenceLevels').addEventListener('keydown', (e) => handleKeySort(e, 'aiIndependenceLevels'));
    document.getElementById('persona').addEventListener('click', () => sortTable('persona'));
    document.getElementById('persona').addEventListener('keydown', (e) => handleKeySort(e, 'persona'));
    document.getElementById('workflow').addEventListener('click', () => sortTable('workflow'));
    document.getElementById('workflow').addEventListener('keydown', (e) => handleKeySort(e, 'workflow'));
    document.getElementById('pricing').addEventListener('click', () => sortTable('pricing'));
    document.getElementById('pricing').addEventListener('keydown', (e) => handleKeySort(e, 'pricing'));
    document.getElementById('indemnity').addEventListener('click', () => sortTable('indemnity'));
    document.getElementById('indemnity').addEventListener('keydown', (e) => handleKeySort(e, 'indemnity'));
    document.getElementById('notes').addEventListener('click', () => sortTable('notes'));
    document.getElementById('notes').addEventListener('keydown', (e) => handleKeySort(e, 'notes'));
